...
export function IPhoneMockup({ src, alt, className, priority }: Props) {
  return (
    <div className={`relative mx-auto w-full max-w-[250px] ${className ?? ""}`}>
      <div className="relative rounded-[2.6rem] border border-white/12 bg-[#0a0a0d] p-[3.2%] shadow-[0_30px_70px_-25px_rgba(0,0,0,0.9)]">
        {/* side buttons */}
        ...
        <div className="relative aspect-[9/19.5] w-full overflow-hidden rounded-[2rem] bg-[#111114]">
          {src ? (
            <Image
              src={src}
              alt={alt}
